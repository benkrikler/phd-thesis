...
Muon-to-electron conversion, as described in the previous chapter, is the process where a muon, bound to the Coulomb potential of an atomic nucleus, decays to an electron without emitting neutrinos.
...
In the aluminium target used in COMET, the lifetime of the muon is 864~ns, whilst the energy of the electron will be 104.97~MeV/c.

\section{Overview of Background Processes}

The \acf{ses}, defined in the previous chapter, is a statement of the ability to observe the signal from such a process.
