...
This amounts to an improvement of four orders of magnitude compared to the current limit by \sindrumII~\cite{sindrum2006}, which requires some significant changes to the way the experiment operates compared to its predecessor.
...
Of these, the dominant background is muon \acf{DIO}, which was described in the previous chapter.
...
Since pion capture against a nucleus is extremely fast, the timing of pion-induced backgrounds is determined solely by the arrival time of pions into the target region.
