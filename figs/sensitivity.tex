...
Projections of the final position of stopped muons in the stopping target.
	...
	The muon beam in these plots is therefore travelling in the negative-$Z$ direction having travelled 180\degree around the bent solenoid.
}
\end{figure}
}
...
\centering
	...
	\hline
							& Single event sensitivity & \multicolumn{1}{p{0.13\textwidth}}{Total \ac{POT} ($\times10^{19}$)} &Beam time $t_\textrm{run}$ (s) & Sensitivity per year of continuous beam \\ 
  \hline
