...
\centering 
%\fbox{
\includegraphics[width=0.95\textwidth,trim=1.5cm 0 2.3cm 1.5cm,clip]{figs/theory/MuLFVSearchLimits.pdf}
%}
\caption{\figlabel{theory:muModesLimits}
...
The vertical green line indicates present day.  
