...
\centering
%\fbox{
\includegraphics[width=1.00\textwidth,trim=0.85cm 0.5cm 0.5cm 0.5cm,clip=true]{figs/software/ICEDUST_structure.png}
%}
\caption
...
\centering
%\fbox{
\includegraphics[width=1.00\textwidth]{figs/software/Simulation_structure.png}
%}
\caption
...
%}
\caption
[How parameters are shared amongst different components of the geometry within ICEDUST.]{
...
\figlabel{software:geom:screenshots}}
\end{figure}
}
...
%}
\caption
[Comparison of the realistic spectra for \ac{DIO} electrons, and protons coming from muon nuclear capture.]{
...
Comparison of protons coming from muon capture between the preliminary result from \alcap~\cite{MeNufactAlCap2015,AlcapProposal2012} and default Geant4 shows that the true proton spectrum is much softer than the Geant4 model.
...
%}
\caption
[The classes involved in simulating the various processes of stopped negative muons.]{
...
%}
\caption
[Fieldmap produced by Opera and G4Beamline.]{
...
%}
\caption
[The ratio of the Opera and G4Beamline fieldmap calculations shown in \fig{software:field}.]{
...
\figlabel{software:beamline:analysis}}
\end{figure}\xspace}
