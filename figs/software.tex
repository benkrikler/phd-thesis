...
Parameter specifications use natural arithmetic notation and can references other parameters, use standard units.
...
On-axis the fields are fairly similar although towards the ends of the solenoids the agreement is poorer.
}
\end{figure}
}
