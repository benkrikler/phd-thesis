...
\begin{tabular}{ll|SSS|SS}
Type                         & Source                   & \multicolumn{3}{c|}{Background Rate}                             & \multicolumn{2}{c}{Total Events} \\ 
                             &                          & {per Stopping $\mu^-$} & {per POT}     & {per \si{s}}            & {This Study} & {CDR~\cite{CDRphase2}} \\ 
\hline
\hline
\multirow{2}{*}{Intrinsic}   & DIO                      & \VarDIOPerMuStop       & \VarDIOPerPOT & \VarDIOPerSecond        & \VarDIOTotal &                       \\ 
                             & RMC                      & \VarRMCPerMuStop       & \VarRMCPerPOT & \VarRMCPerSecond        & \VarRMCTotal &                       \\ 
\hline
\multirow{3}{*}{Delayed}     & RPC                      & {--}                   &               & \VarRPCDelayedPerPOT    &              &                       \\ 
                             & Beam $e^-$               & {--}                   &               &                         &              &                       \\ 
                             & Stopped $\bar{p}$        & {--}                   &               &                         &              &                       \\ 
\hline
\multirow{3}{*}{Prompt}      & RPC                      & {--}                   &               & \VarRPCPromptPerPOT     &              &                       \\ 
                             & Beam $e^-$               & {--}                   &               &                         &              &                       \\ 
                             & $\pi^{-}$ from $\bar{p}$ & {--}                   &               &                         &              &                       \\ 
\hline
\multicolumn{2}{c|}{Cosmics}                            & {--}                   & {--}          & \VarCosmicRatePerSecond &              &                       \\ 
\hline
\hline
