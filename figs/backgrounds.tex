...
The vertical coloured lines have been added to indicate these energies, whilst the horizontal bands the predicted cross sections for the models of proton-nucleon and proton-nucleus interaction.
}
\end{figure}
}
...
\begin{tabular}{rcl|r|SS}
\multicolumn{3}{c|}{\multirow{2}{*}{Region}} & \multirow{2}{*}{Data Source} & \multicolumn{2}{c}{Total $\bar{p}$ per POT} \\ 
& &                                          &                              & {Linear Tail}       &  {Exponential Tail} \\ 
\hline
                  $0 \le$   & $\theta<$ & $59\degree$  & 10\degree \cite{Kiselev:2012sj}    & 9.13e-05 & 5.26e-05 \\ 
                  $59 \le$  & $\theta<$ & $97\degree$  & 59\degree \cite{Kiselev:2012sj}    & 2.64e-08 & 4.17e-09 \\ 
                  $97 \le$  & $\theta<$ & $119\degree$ & 97\degree \cite{Boyarinov:1994tp}  & 3.40e-12 & 1.74e-12 \\ 
                  $119 \le$ & $\theta<$ & $180\degree$ & 119\degree \cite{Boyarinov:1994tp} & 2.58e-12 & 5.71e-13 \\ 
\hline
\end{tabular}
...
\centering
	...
	\hline
        Parameter & \multicolumn{1}{l}{Value} & Description \\
	\hline
        $A_\textrm{geom}$ & \VarBeamBgGeometric &  Geometric Acceptance to High-momentum Electrons per POT\\ 
...
Distributions of momenta and the transverse direction for the muons and antimuons provided by the ND280 collaboration.
}\end{figure}\xspace}
...
\toprule
Type                         & Source                   & \multicolumn{3}{c|}{Background Rate}                                       & \multicolumn{1}{c}{Total Events} \\ 
                             &                          & {per $\mu^-$ stop} & {per POT}              & {per second}            & {This Study}           \\ 
\toprule
...
\multirow{4}{*}{Delayed}     & RPC                      & {--}             & \NumRPCDelayedPerPOT             & \NumRPCDelayedPerSec             & \NumRPCDelayedTotal               \\ 
                             & Beam                     & {--}             & \NumBeamBgDelayedPerPOT           & \NumBeamBgDelayedPerSec           & \NumBeamBgDelayedTotal          \\ 
                             & Stopped $\bar{p}$        & {--}             & \NumBgAntiprotonsPerPOT          & \NumBgAntiprotonsPerSec          & \NumBgAntiprotonsTotal            \\ 
...
\cmidrule{2-6}
\multicolumn{2}{c|}{Cosmics}                            & {--}             & {--}                             & \NumCosmicRatePerSecond          & \NumCosmicRateTotal               \\ 
\bottomrule                                                                                                   
\multicolumn{2}{c|}{Total}                              & {--}             & {--}                             & \NumTotalBgPerPOT                & \NumTotalBgPhasII                 \\ 
\bottomrule
\end{tabular}
\end{adjustwidth}
...
Assumes an extinction factor of \VarExtinctionFactor, a momentum resolution with $\sigma=200$~keV/c and a probability of \num{1e-4} that events are misreconstructed with at least an additional 2.4~MeV/c. 
