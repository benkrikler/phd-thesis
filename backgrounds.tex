...
\begin{equation}
\xi=\frac{\sigma_\mathrm{tot}(E_p=8\textrm{~GeV})}{\sigma_\mathrm{tot}(E_p=10.14\textrm{~GeV})}
\end{equation}
...
Reducing the beam power further, by around 500 MeV would reduce the cross section by 75 to 90\% of the current estimate, \ie lower the production rate by about one order of magnitude.
