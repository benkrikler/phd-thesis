...
\phaseII is expected to run about \VarRunTime~s as suggested in section~\sec{sensitivity}.
...
\Fig{bg:cosmic:input} shows the distributions of momentum and directions that these files contained.
