...
\end{equation}
where $N_\mu$ has been expanded to the proton beam current divided by the proton charge, $I_p/e$, times the muon stopping rate per \ac{POT}, $R_\mu\textrm{-stop}$.
\Tab{sense:ses} lists the values of these parameters, from which we can see that a single signal event sensitivity of \sensePII can be achieved in around \sci{1.21}{7} seconds or about 140 days.
Alternatively, if we ran for some \sci{2}{7} seconds, a \acf{ses} of \sci{1.8}{-17} would be possible.
...
\begin{table}[b]
\centering
        \begin{tabular}{m{0.25\textwidth}p{0.16\textwidth}p{0.15\textwidth}p{0.25\textwidth}}
	\hline
                                           & Single event sensitivity & Beam time $t_\textrm{run}$ (s) & Sensitivity per year of continuous beam \\ 
\hline
                COMET \phaseII\hspace{1ex}(this study)                & \sci{2.6}{-17}        & \sci{1.40}{7}                   & \sci{1.15}{-17}                         \\ 
                COMET \phaseII\hspace{1ex}(CDR 2009~\cite{CDRphase2}) & \sci{2.6}{-17}        & \sci{2.00}{7}                   & \sci{1.65}{-17}                         \\ 
Mu2e~\cite{Mu2e2014}                       & \sci{2.4}{-17} & \sci{6.00}{7}                   & \sci{4.57}{-17}                         \\ 
COMET \phaseI~\cite{TDR2016}               & \sci{3.0}{-17}        & \sci{1.26}{7}                   & \sci{1.19}{-15}                         \\ 
	\hline
\end{tabular}
