...
Firstly the correlation between Z and Y shown in \fig{sense:stops:ZY} arises due to the disperse muon beam arriving at the target. 
...
\Fig{sense:timing:signal} shows the arrival time of signal electrons \CHECK{Add the muon stopping time, and beam flash timing to this plot?}.
