...
A bunch event in \phaseI will consist of about 8$\times10^{6}$~\ac{POT} so, without resampling, a simulation of 8$\times10^{8}$~\ac{POT} events could only produce 100 bunches.
