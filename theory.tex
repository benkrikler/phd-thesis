...
In both cases, something new was needed to resolve these issues.
...
This is apparent from the fact that New Physics can be classed as photonic (such as the lower three diagrams in \fig{theory:feyn:muecNP}) or like a four-Fermi contact interaction (as in the upper three diagrams in \fig{theory:feyn:muecNP}).
