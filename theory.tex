...
\Tab{theory:currentLimits} shows the current limits on a (non-exhausted) list of the possible \ac{CLFV} observables.
...
\Fig{theory:feyn:mueconv} shows a whole host of Feynman diagrams involving new particles and couplings predicted from many BSM theories.
