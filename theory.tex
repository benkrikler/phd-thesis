...
There were two obvious possibilities for the `something else'~\cite{Pontecorvo:1947vp}: a photon, or a pair particles, known as neutrinos.
...
Thus, not only had the discovery of the muon been the discovery of a new charged particle, but it was also responsible for a new neutrino and a new law of conservation!
...
In the case of leptoquarks for example, shown in \fig{theory:feyn:muecNP:Leptoquark}, one can expect \mueconv to take place at tree, whilst generating a signal in a \muThreeE experiment can only occur via loop diagrams.
