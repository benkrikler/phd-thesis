...
%given as half-lengths following the Geant4 convention.  
...
Since this is a different way to analyse the acceptance compared to the survival probability it would not suffer to the artefact seen for low dipole field values in \fig{optim:ESTDipole:MeanFlux}.
